 ...
 *
 * ---------------------------
 * XYLineAndShapeRendererOwn.java
 * ---------------------------
 ...
 *
 */
public class XYLineAndShapeRendererOwn extends AbstractXYItemRenderer
     ...
     */
    public XYLineAndShapeRendererOwn() {
        this(true, true);
    }
     ...
     */
    public XYLineAndShapeRendererOwn(boolean lines, boolean shapes) {
                ...
                if (this.drawOutlines) {
                    ...
                    if (!(pumps || incident)) {
                    	...
                    	try {
                    		Image image = null;
                        	if (pumps) {
                        		image = ImageIO.read(new File("lib/pump.png"));
                        	}
                        	else if (incident) {
                        		image = ImageIO.read(new File("lib/truck_mirrored.png"));
                        	}
                    		if (dataArea.getHeight() < 200) {
                    			g2.drawImage(image, (int) transX1-10, (int)transY1 -8, 20, 15,null);
                    		}
                    		else {
                    			g2.drawImage(image, (int) transX1-20, (int) transY1 -15, 40, 30,null);
                    		}
						} catch (IOException e) {
    ...
    public Object clone() throws CloneNotSupportedException {
        XYLineAndShapeRendererOwn clone = (XYLineAndShapeRendererOwn) super.clone();
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof XYLineAndShapeRendererOwn)) {
            return false;
        }
        if (!super.equals(obj)) {
            return false;
        }
        XYLineAndShapeRendererOwn that = (XYLineAndShapeRendererOwn) obj;
